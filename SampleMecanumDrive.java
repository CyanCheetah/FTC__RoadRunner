...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    private DcMotorEx frontl, bottoml, bottomr, frontr;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        bottoml = hardwareMap.get(DcMotorEx.class, "bottoml");
        bottomr = hardwareMap.get(DcMotorEx.class, "bottomr");
        frontr = hardwareMap.get(DcMotorEx.class, "frontr");


        motors = Arrays.asList(frontl, bottoml, bottomr, frontr);
